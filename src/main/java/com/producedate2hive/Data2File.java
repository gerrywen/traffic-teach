...
import com.bjsxt.TrafficTeachApplication;
...
public class Data2File {
    private static String MONITOR_FLOW_ACTION = "./monitor_flow_action";
    private static String MONITOR_CAMERA_INFO = "./monitor_camera_info";
...
//        String jsonPath = Objects.requireNonNull(TrafficTeachApplication.class.getClassLoader().getResource("json")).getFile();
